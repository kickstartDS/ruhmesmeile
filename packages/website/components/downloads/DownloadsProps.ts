...
/**
 * Select a SharePoint folder to automatically list its files as downloads. When set, replaces manually added download items.
 */
export type SharePointFolder = string;
